member = [
  ...
  {"id":"admin","pw":"5555","name":"김구","nicName":"구스","address":"대구시","money":1000000000},
]

# member.txt파일 생성해서 csv형태로 문자열로 저장하시오.
...
# ]
# # students 딕셔너리 파일을 메모장에 csv파일형태로 저장하시오.
...
# f = open('students.txt','w',encoding='utf-8')
# f.write("1,홍길동,100,100,99,299,99.6666666667,0\n")
# f.close()
