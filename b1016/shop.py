...
def buy(choice,cartNo):
  ...
  c = {"cno":cartNo+1,"id":session_info['id'],"name":session_info['name'],"pCode":product[choice-1]['pCode'],"pName":product[choice-1]['pName'],"price":2000000,"date":today}
...
def buy_save():
  ...
  f.close()
  # cart.txt파일 생성해서 csv형태로 문자열로 저장하시오.
