...
# Exception : 모든 예외처리의 부모, 예외처리에서 마지막에 위치해야 함
...
try:
  print("3")
  print("4")
  raise  NotImplementedError("프로그램을 구현해야 함.")  # 프로그램이 구현되어 있지 않음(강제에러)
  # print(10/0)  # 강제에러
  print("5")
...
# except Exception as e:
#   print("모든 예외처리의 부모")  # 모든 예외처리의 부모이기 때문에 젤 마지막에 위치.(무조건 넣어야함)
