...
### 함수선언 ###
def stuScroe_uqdate(choice,k_title,s_title,s):
  ...
  if choice == "1":
    ...
    for s in students:
      if s['name'] == search:
        ...
        if choice == 1:
          stuScroe_uqdate(choice,subject[choice],"kor",s)         
        elif choice == 2:
          stuScroe_uqdate(choice,subject[choice],"eng",s)
        elif choice == 3:
          stuScroe_uqdate(choice,subject[choice],"math",s)
        elif choice == 0:
          print("이전화면으로 이동합니다.")
          break
