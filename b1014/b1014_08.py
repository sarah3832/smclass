...
# 매개변수가 복합변수 일경우, return 없어도 값이 변경되어 전달됨.
# def add(h):
...
# sum = 100  # 외부의 변수를 사용해서 계산을 하고싶을 경우
# sum = calc(1,10)
...
# print(1,2,3,3,4,2,3,3,sep=",",end="\t")  # 가변매개변수
# print("안녕")
...
# def calc(num,num2):
#   print(f"두수의 더하기 : {num+num2}")
#   print(f"두수의 빼기 : {num-num2}")
#   print(f"두수의 곱하기 : {num*num2}")
#   print(f"두수의 나누기 : {num/num2}")
...
# # 3개의 숫자를 입력받아 숫자를 계산하시오. ex) 12,5,3
# def calc(num,num2,num3):
#   print(f"두수의 더하기 : {num+num2+num3}")
#   print(f"두수의 빼기 : {num-num2-num3}")
#   print(f"두수의 곱하기 : {num*num2*num3}")
#   print(f"두수의 나누기 : {num/num2/num3}")
...
# for i in range(len(num)):
#   print(f"두수의 더하기 : {num[i]+num2[i]}")
#   print(f"두수의 빼기 : {num[i]-num2[i]}")
#   print(f"두수의 곱하기 : {num[i]*num2[i]}")
#   print(f"두수의 나누기 : {num[i]/num2[i]}")
