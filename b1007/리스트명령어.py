...
# print(a_list[::2])   # [1,3,5] / 2스텝
# print(a_list[::-2])  # [5,3,1] / 뒤에서부터 2스텝
# print(a_list[::-1])  # [5,4,3,2,1] / 역순출력
# print(a_list[:])     # [1,2,3,4,5] / 전체출력
# print(a_list)        # [1,2,3,4,5] / 전체출력
...
# 얕은복사, 깊은복사
# a_list = [1,2,3,4,5]
# b_list = a_list  # 얕은복사 (주소값만 복사, a_list의 값을 변경하면 b_list값 변경)
# a_list[0] = 100
# print(a_list)
# print(b_list)

# a_list = [1,2,3,4,5]
# b_list = a_list[:]  # 깊은복사 (a_list의 값을 변경해도 b_list값 변경이 안됨)
# a_list[0] = 100
# print(a_list)
# print(b_list)
