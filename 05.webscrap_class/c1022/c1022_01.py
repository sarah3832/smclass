...
# print(res.text)  # 타임 str

# 태그를 활용한 검색방법
# find, find_all, <-> select_one(한개 검색),selcet(여러개 검색)
...
# data = soup.select_one("#wrap > div.rankingnews._popularWelBase._persist > div.rankingnews_box_wrap._popularRanking")  # 웹에서 select 복사
