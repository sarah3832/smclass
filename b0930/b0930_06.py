...
for s_t in stu_title:
  print("{}".format(s_t),end='\t')  # end=' ' : 줄단락 가로로 (end='\n')
print()  
print("-"*60)
...
# 이순신의 평균을 출력하시오
# print("이순신 평균 : {}".format((stu_datas[0][1]+stu_datas[0][2]+stu_datas[0][3]+stu_datas[0][4])/4))
...
# 한번에 2개의 길이를 입력받아, 삼각형 넓이, 직사각형 넓이를 구하시오
...
# t1 = float(input("밑변 길이를 입력하세요."))
# t2 = float(input("높이 길이를 입력하세요."))
# area = t1 * t2 * 0.5
# print("삼각형 넓이 :",area)

# l1 = float(input("밑변 길이를 입력하세요."))
# l2 = float(input("높이 길이를 입력하세요."))
# area = l1 * l2 
# print("직사각형 넓이 :",area)
...
# # print(int(b))  # 실수형 문자열 -> 실수타입으로만 변경가능
